...
if($student){
 ...
 ?>
        ...
        if($pass){
          ...
          <hr>
          You have paid  <b><?= $paid; ?> Rfw</b>. <?php if($due<0){ echo ' You have exceeded <b>'. ($due*-1).' Rfw</b> on ';}else{ ?>You need to pay <b><?= $due; ?> Rfw</b> to complete <?php } ?> your schoolfees of <b><?= $topay; ?> Rfw</b> <?php if(isset($mods) and $mods['allmod']>0){ echo ' of <b>'.$mods['allmod'].' modules</b> attended';} ?>.
...
<!--  -->
          ...
          <hr>
          <br>
           You have paid  <b><?= $paid; ?> Rfw</b>. <?php if($due<0){ echo ' You have exceeded <b>'. ($due*-1).' Rfw</b> on ';}else{ ?>You need to pay <b><?= $due; ?> Rfw</b> to complete <?php } ?> your schoolfees of <b><?= $topay; ?> Rfw</b> .
               <br>For more information contact <b>DVC/AF</b>.
          <?php
        }else{
          ?>
