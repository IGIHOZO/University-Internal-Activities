            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title ">Student QR</h4>
                  <p class="card-category">Type student Registration Number to search</p>
                  <div id="button" style="display: none;">
                    
                    <button id="download" value="">Download</button>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title ">Student QR</h4>
                  <p class="card-category">Save Student QR Code below</p>
                  <p id="names" style="display: none;"></p>
                </div>
                <div class="card-body">
                  <div id="qrcode">
